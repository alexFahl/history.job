...
const analyzeJobOffer = async (req, res) => {
  try {
    ...
    const prompt = `
      ...
      - "salaryExpected": The salary range or exact salary mentioned (e.g., "30000 - 34000" or "30K - 34K"). Exclude the currency symbol if possible.
    ...
    const completion = await groq.chat.completions.create({
      ...
      // Using Llama 3 8B, which is incredibly fast and great for extraction
